...
public class EventAdapterTwo extends RecyclerView.Adapter<EventViewHolder> {

    Context context;
    ArrayList<Event> events;
    EventRVInterface eventRVInterface;

    public EventAdapterTwo(Context context, ArrayList<Event> events, EventRVInterface eventRVInterface) {
